...
/// </summary>
public class TranscriberConverter : JsonObjectConverter<ResourceObject>
{
    ...
    public TranscriberConverter(IResourceGraph resourceGraph)
    {
        _resourceGraph = resourceGraph;
    }
    public override bool CanConvert(Type typeToConvert)  {
            var isit = typeof(ResourceObject).IsAssignableFrom(typeToConvert);
            return isit;
        }
