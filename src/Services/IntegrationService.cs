...
namespace SIL.Transcriber.Services
{
    public class IntegrationService : BaseArchiveService<Integration>
    {
        ...
        public IntegrationService(
            ...
            IResourceDefinitionAccessor resourceDefinitionAccessor, IntegrationRepository repository) 
            : base(repositoryAccessor, queryLayerComposer, paginationContext, options, 
                  loggerFactory, request, resourceChangeTracker, resourceDefinitionAccessor,repository)
        {
        }
    }
}
